...
public class SinglyLinkedList_driver
{
    public static void main(String[] args) {
        ...
        linked_list.insert_head(6);		// 6
        linked_list.insert_head(8);		// 8 - 6
        linked_list.insert_head(11);	// 11 - 8 - 6
        linked_list.insert(4);			// 11 - 8 - 6 - 4
        linked_list.insert_nth(1, 4);	// 11 - 8 - 6 - 4 - 1

        /// Use toString() to show all the elements.
        System.out.println("The numbers in the list are: " + linked_list);
        ...
        // Current list: 11 - 8 - 6 - 4 - 1
        /// Testing deletion
        linked_list.delete_head();	// 8 - 6 - 4 - 1
        linked_list.delete_nth(1);	// 8 - 4 - 1
        linked_list.delete();	// 4 - 1
